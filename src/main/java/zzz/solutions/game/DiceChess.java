package zzz.solutions.game;

import zzz.framework.chess.Opportunities;
import zzz.framework.chess.OpportunityManager;
import zzz.framework.chess.PermissionManager;
import zzz.framework.chess.Permissions;
import zzz.framework.game.Game;
import zzz.framework.game.GameManager;
import zzz.framework.game.Location;
import zzz.framework.game.Player;
import zzz.framework.game.Setup;
import zzz.framework.game.Unit;
import zzz.framework.gui.GraphicalUserInterface;
import zzz.framework.utility.Console;
import zzz.framework.utility.Engine;
import zzz.framework.utility.Recordable;
import zzz.framework.utility.Recoverable;
import zzz.solutions.chess.board.Square;
import zzz.solutions.chess.pieces.Bishop;
import zzz.solutions.chess.pieces.King;
import zzz.solutions.chess.pieces.Knight;
import zzz.solutions.chess.pieces.Pawn;
import zzz.solutions.chess.pieces.Queen;
import zzz.solutions.chess.pieces.Rook;
import zzz.solutions.chess.utility.CastlePermissions;
import zzz.solutions.chess.utility.EPOpportunities;
