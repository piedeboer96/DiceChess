...
public class Bishop extends ChessPiece {
	...
	public Bishop(char fen, int file, int rank) {
		...
		movementInfo[0] = new ChessMoveInfo(7, 1, 1);
		movementInfo[1] = new ChessMoveInfo(7, 1, -1);
		movementInfo[2] = new ChessMoveInfo(7, -1, 1);
		movementInfo[3] = new ChessMoveInfo(7, -1, -1);
	}
