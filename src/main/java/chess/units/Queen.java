...
public class Queen extends ChessPiece
{
    ...
    public Queen(char fen, int file, int rank)
    {
        ...
        movementInfo[4] = new ChessMoveInfo(8, 1, 1);
        movementInfo[5] = new ChessMoveInfo(8, 1, -1);
        movementInfo[6] = new ChessMoveInfo(8, -1, 1);
        movementInfo[7] = new ChessMoveInfo(8, -1, -1);
    }
