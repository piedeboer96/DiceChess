...
public interface IChessPiece extends IChessBoardSquare, IGhost
{
    ...
    /**
     * Gets the information of the moves the chess piece is capable of.
     * See IChessMoveInfo for more information.
     **/
    ...
    /**
     * Determines whether a chess piece is allowed to be promoted to another chess piece.
     **/
    boolean promotable();
    ...
    /**
     * Gets the team, also known as the color, of the chess piece.
     * The number 0 represents the color black, whereas the number 1 represents the color white.
