package phase1version.examples;

import phase1version.chess.ChessMatch;
import phase1version.gui.ChessWindow;
...
public class JustShowChessBoard {
	...
	public void mainLoop() {
		...
		startPos = "k7/pppppppp/8/8/8/8/8/R1N1K2R w KQkq - 0 1";
			
		startPos = "1r6/2p3pp/p1p2k2/4p3/8/8/3N2B1/R3K2R w KQkq - 0 1";
