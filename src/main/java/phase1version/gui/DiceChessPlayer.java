...
import phase1version.gui.interfaces.IChessboard;
import phase1version.gui.interfaces.IHighlighter;
import phase1version.gui.interfaces.IWindow;
...
public final class DiceChessPlayer extends Player {
	...
	public void mousePressed(MouseEvent e) {
		...
		if (clickSource instanceof IChessboard chessboard && rollResults != null) {
		...
		else if (clickSource instanceof Dice dice && rollResults == null) {
			// Getting the dice
