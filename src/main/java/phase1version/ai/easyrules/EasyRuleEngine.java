...
import phase1version.ai.easyrules.rules.AttackRule;
import phase1version.ai.easyrules.rules.EscapeFromEatRule;
import phase1version.ai.easyrules.rules.KingDeadRule;
import phase1version.ai.easyrules.rules.LongCastleRule;
import phase1version.ai.easyrules.rules.MoveByPositionRule;
import phase1version.ai.easyrules.rules.MoveForwardRule;
import phase1version.ai.easyrules.rules.MoveToMateRule;
import phase1version.ai.easyrules.rules.NewBestActionRule;
import phase1version.ai.easyrules.rules.NotSuicideRule;
import phase1version.ai.easyrules.rules.PromoteRule;
import phase1version.ai.easyrules.rules.ShortCastleRule;
