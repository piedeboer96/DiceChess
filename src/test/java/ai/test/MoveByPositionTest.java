...
class MoveByPositionTest {
	...
	void testPawn() {
		...
		assertEquals(PieceSquareTable.pst_PAWN[5][0], move.possibilities().get(0).getScore());
		System.err.println(PieceSquareTable.pst_PAWN[5][0]);
		assertEquals(PieceSquareTable.pst_PAWN[4][0], move.possibilities().get(1).getScore());
	...
	void testKing() {
		...
		rulesEngine.fire(rules, facts);
		System.out.println("move = " + move);
		assertEquals(PieceSquareTable.pst_KING_MIDGAME[5][0], move.possibilities().get(0).getScore());
	}
